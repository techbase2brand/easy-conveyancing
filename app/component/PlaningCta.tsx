...
const PlaningCta = ({ title, description, whatsappNumber, buttonText }: PlaningCtaProps) => {
      ...
      <div className="max-w-[1320px] mx-auto">
        ...
        <div className="bg-white shadow-[0px_37px_28px_0px_#0000000A] rounded-4xl text-center px-6 py-8 md:px-12 md:py-10">
          ...
          <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 border hover:border-black border-red-500 text-xs md:text-sm text-black hover:text-white font-semibold px-3 py-1 rounded-lg hover:bg-black transition">
            {/* SVG */}
...
export default memo(PlaningCta);