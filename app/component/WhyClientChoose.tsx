...
const WhyClientChoose = ({ title, description, imageUrl, item }: WhyClientChooseProps) => {
    const checkArrow = ((
                        ...
                        {imageUrl && (
                            <div className="relative">
                                <img
                                    src={imageUrl}
                                    alt={title || "Image"}
                                    className="rounded-lg w-full h-auto object-cover mb-0 md:mb-[-80px]"
                                />
                            </div>
                        )}
                    </div>
...
export default memo(WhyClientChoose);