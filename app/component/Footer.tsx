    ...
    const contactInfoContent = (
        <div className='mt-2 space-y-3'>
            ...
            <div className='list-itemed'>
                ...
                <Link href="https://www.google.com/maps/place/42+Jackaroo+Cres,+Walkley+Heights+SA+5098,+Australia/data=!4m2!3m1!1s0x6ab0b5dc122393dd:0x9d3f5acc37fa4607?sa=X&ved=1t:242&ictx=111" className='text-sm text-secondary hover:underline hover:text-primary transition-all block break-all text-sm md:text-base' target="_blank" rel="noopener noreferrer">
                    42 Jackaroo Cres, Walkley Heights SA 5098
                </Link>
            </div>
        </div>
    );
