...
const Consulting = ({
  ...
  return (
    <section className=" px-4 sm:px-6 lg:px-8 ">
      <div className="max-w-[1320px] mx-auto  bg-primary rounded-4xl">
        <div className="flex flex-col lg:flex-row items-center gap-0 md:gap-8">
          ...
          <div className="flex-1 p-8 md:p-10">
            ...
            <p className="text-1xl sm:text-1xl md:text-3xl font-medium text-white mb-4 md:mb-8">
              {description}
            </p>

            {/* Button (Safe Rendering) */}
            {buttonUrl && buttonText && (
              <Link
                  ...
                  href={buttonUrl}
                  className="inline-flex items-center gap-2 pl-3 pr-3 sm:pr-4 py-1.5 sm:py-1.5 font-semibold border-1 border-white bg-[#910005] hover:bg-white text-white hover:text-black rounded-xl shadow-md transition-all text-sm">
                  {whatsapIcon}
                  {buttonText}
                </Link>
            )}
